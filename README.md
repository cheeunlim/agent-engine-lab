...
#### 🚨 **배포가 완료될 때까지 10여분의 시간이 소요됩니다. 대기 후 아래 화면과 같은 에이전트 배포 완료 메시지를 확인합니다. ** 
...
#### 4. Google Cloud 콘솔의 좌측 메뉴에서 Agent Engine 을 클릭합니다.

![image](https://raw.githubusercontent.com/cheeunlim/agent-engine-lab/main/images/agent_engine_menu.png)


#### 5. 배포된 Agent Engine 을 확인 후 Resource name을 복사해 메모장에 기록하고, Agent를 클릭합니다.

![image](https://raw.githubusercontent.com/jk1333/handson/main/images/6/5.png)

#### 6. Playground 메뉴에 들어가서 다양한 대화를 해봅니다.
...
#### 7. 다양한 대화를 수행해본 후 Memories 메뉴에 접속하여 발화 내용이 메모리에 추가되었는지 확인합니다.

![image](https://raw.githubusercontent.com/jk1333/handson/main/images/6/7.png)



#### 8. Dashboard, Traces, Sessions 메뉴를 클릭하며 각 기능을 살펴봅니다.

<br>

## 📍 실습 Part 3

#### 9. Google Cloud 콘솔 검색 메뉴에서 "credentials" 혹은 "oauth" 를 검색하면 나오는 Credentials 를 클릭합니다.
...
**Authorized redirect URI** 에는 아래 링크 내용을 복사해 입력합니다.
...
#### 10. 기록한 Credential 정보와 Agent Engine 의 Resource Name을 Makefile에 업데이트 합니다.
...
#### 11. Jupyter Lab 의 Terminal 로 돌아와 아래의 명령어를 실행하여 에이전트를 Gemini Enterprise에 등록합니다.
...
#### 14. Google Drive 데이터 스토어 생성
Apps를 클릭한 다음 미리 구성된 'agent-portal' 앱을 클릭합니다.
Connected data stores 를 클릭하여 이동한 화면에서 New data store > Google Drive 를 클릭합니다.

![image](https://raw.githubusercontent.com/jk1333/handson/main/images/6/13.png)


Drive 선택 중 기본값인 "All" 선택을 유지한 후 Continue 버튼을 클릭합니다.
'drive' 혹은 임의의 이름을 입력해준 후 create 버튼을 눌러 생성합니다.

![image](https://raw.githubusercontent.com/cheeunlim/agent-engine-lab/main/images/drive_connector.png)


#### 15. 생성 완료 시 아래와 같은 "Active" 상태를 확인합니다. 

![image](https://raw.githubusercontent.com/cheeunlim/agent-engine-lab/main/images/drive_active.png)
...
Authorize 버튼을 클릭한 후, 사용자의 Google Drive에 접근 권한을 부여합니다.
...
#### 18. 구글 드라이브(https://drive.google.com) 에 접속하여 파일이 생성됐는지 확인합니다.
